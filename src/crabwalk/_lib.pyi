...
class Types(MutableMapping[str, VOut]):
    @overload
    def __init__(
        self, __m: SupportsKeysAndGetItem[str, VIn], **kwargs: VIn
    ) -> None: ...
    @overload
    def __init__(self, __m: Iterable[tuple[str, VIn]], **kwargs: VIn) -> None: ...
    @overload
    def __init__(self, **kwargs: VIn) -> None: ...
...
class Walk:
    ...
    def disable_standard_filters(self) -> None: ...
    def enable_standard_filters(self) -> None: ...
    @property
